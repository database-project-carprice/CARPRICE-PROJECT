                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form id="ajax-register-form" action="http://phpoll.com/register/process" method="post" role="form" autocomplete="off">
                                        <div class="form-group">
                                            <input type="text" name="username" id="regiter-username" tabindex="1" class="form-control" placeholder="Username" value="">
                                        </div>
                                        <div class="form-group">
                                            <input type="email" name="email" id="register-email" tabindex="1" class="form-control" placeholder="Email Address" value="">
                                        </div>
                                        <div class="form-group">
                                            <input type="driver-license" name="driver-license" id="register-driver-license" tabindex="1" class="form-control" placeholder="Driver License" value="">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form id="ajax-login-form" action="index.php" method="post" role="form" autocomplete="off">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" id="login-username" tabindex="1" class="form-control" placeholder="Username" value="" autocomplete="off">
                                        </div>

                                        <div class="form-group">
                                            <label for="password">Password</label>
                                            <input type="password" name="password" id="login-password" tabindex="2" class="form-control" placeholder="Password" autocomplete="off">
                                        </div>
